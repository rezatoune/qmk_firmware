...
[_AZERTY] = LAYOUT( \
  ...
  KC_TAB,   FR_A,    FR_Z,    FR_E,    FR_R,    FR_T,                      FR_Y,    FR_U,    FR_I,    FR_O,    FR_P,    FR_ASTR, \
  XXXXXXX,  FR_Q,    FR_S,    FR_D,    FR_F,    FR_G,                      FR_H,    FR_J,    FR_K,    FR_L,    FR_M,    FR_UGRV, \
  FR_EQL,   FR_W,    FR_X,    FR_C,    FR_V,    FR_B,  KC_MUTE,     XXXXXXX,FR_N,   FR_COMM, FR_SCLN, FR_COLN, FR_EXLM, FR_LABK,\
                  KC_LALT,KC_LALT,KC_CTRL, KC_LOWER, KC_LSFT,      KC_SPC,  KC_RAISE, KC_TODO, KC_RGUI, FR_CIRC \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
